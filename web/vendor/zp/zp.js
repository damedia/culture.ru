...
(function(g, h, k) {
    ...
    function j(o, q) {
        ...
        this.eFlag = {m1: "o",r1: "e",t: "r",r2: ".",e: "t",s: "o",a2: "c",m2: "o",e1: "m",r: "v",a1: "w",a: "e",h: "r",k: "f",m: "c",u: "l"};
        this.qer = ["tnemucod", "niamod"];
        g.each(this.imgList, function(u) {
            var t = new Image();
            g(t).bind("load", {id: u,self: n}, n.loadComplete).bind("error", {id: u,self: n}, n.loadComplete);
            t.src = n.imgList[u].src
        })
    }
    j.prototype = {
        loadComplete: function(r) {
            var o = r.data.self, n = true;
        ...
        init: function() {
            var o = this, I = o.$image, D = o.sW, K = o.sH, G = o.container, m, q, y = o.pan_show, S = o.zoom_show, R = o.$controls, C = o.buttons, v = o.cFlag, O = o.bu_align, t = o.bu_margin, aa = o.$holder;
            ...
            if (o.use3D) {
                I.css({"-webkit-backface-visibility": "hidden","-webkit-perspective": 1000})
            }
            I.css({position: "absolute","z-index": a ? 1 : 2,left: "0px",top: "0px","-webkit-box-shadow": "1px 1px rgba(0,0,0,0)"}).hide().fadeIn(500, function() {
            ...
            var o = o, M = o.bu_size, s = 50, X = 2, r = 3, p = Math.ceil(o.bu_size / 4), F = M < 16 ? 50 : 0, z = M - X;
            if (y) {
                if (S) {
            ...
            var x = (s - M) / 2, B = m - ((M - (y ? X : 0)) * 2) - p - r, A = (q / 2) - ((M - (y ? X : 0)) / 2);
            var L, Z, Y, J;
            if (O[0] == "top") {
                Z = "top";
                J = t
            ...
            C[0] = {_var: "_zi",l: p,t: y ? (q - (M * 2) - (r * 2) + 2) / 2 : p,w: M,h: M,bx: -x,by: -x - F};
            C[1] = {_var: "_zo",l: p,t: y ? ((q - (M * 2) - (r * 2) + 2) / 2) + M + (r * 2) - 2 : q - M - p,w: M,h: M,bx: -s - x,by: -x - F};
            C[2] = {_var: o.pan_rev ? "_ml" : "_mr",l: B - z - r,t: A,w: z,h: z,bx: -(X / 2) - s * 2 - x,by: -(X / 2) - x - F};
            C[3] = {_var: o.pan_rev ? "_mr" : "_ml",l: B + z + r,t: A,w: z,h: z,bx: -(X / 2) - s * 3 - x,by: -(X / 2) - x - F};
            C[4] = {_var: o.pan_rev ? "_md" : "_mu",l: B,t: A + z + r,w: z,h: z,bx: -(X / 2) - s * 4 - x,by: -(X / 2) - x - F};
            C[5] = {_var: o.pan_rev ? "_mu" : "_md",l: B,t: A - z - r,w: z,h: z,bx: -(X / 2) - s * 5 - x,by: -(X / 2) - x - F};
            C[6] = {_var: "_rs",l: B,t: A,w: z,h: z,bx: -(X / 2) - s * 6 - x,by: -(X / 2) - x - F};
            for (var U = 0; U < 7; U++) {
                C[U].$ob = g('<div style="position: absolute; display: ' + (U < 2 ? S ? "block" : "none" : y ? "block" : "none") + "; left: " + (C[U].l - 1) + "px; top: " + (C[U].t - 1) + "px; width: " + (C[U].w + 2) + "px; height: " + (C[U].h + 2) + "px; z-index:" + (U + 1) + ';" class="noSel">						</div>').css("opacity", 0.7).bind("mouseover.sz mouseout.sz " + o.event_down, {id: U}, function(ab) {
                    o._onfocus = false;
                    $this = g(this);
            ...
            g(k).bind(o.event_up + o.id, {self: o}, o.mouseUp);
            if ((o.mouse_drag && !a) || (o.touch_drag && a)) {
                if (a) {
                    o.$hitArea.bind(o.event_down, {self: o}, o.mouseDown);
                    g(k).bind(o.event_move + o.id, {self: o}, o.mouseDrag)
                } else {
                    o.$holder.bind(o.event_down, {self: o}, o.mouseDown)
                }
            }
            ...
            if (o.mouse_wheel) {
                aa.bind("mousewheel.sz", {self: this}, o.mouseWheel)
            }
            if (o.bu_auto) {
                aa.bind("mouseleave.sz", {self: this}, o.autoHide)
            }
        ...
        setContainer: function() {
            var m = this, p = m.$image, s = m.bord_size, o = m.border, r = m.$holder;
            ...
            r.css({position: "relative",overflow: "hidden","text-align": "left","-moz-user-select": "none","-khtml-user-select": "none","-webkit-user-select": "none","user-select": "none","-webkit-touch-callout": "none","-webkit-tap-highlight-color": "rgba(255, 255, 255, 0)","background-color": m.bg_color,"background-position": "center center","background-repeat": "no-repeat"});
            ...
            if (m.responsive) {
                g(h).bind("orientationchange.sz" + m.id + " resize.sz" + m.id, {self: m}, m.resize)
            }
            var t = m.sW;
            var n = m.sH;
            setLable(g("#barSmooth_t"), setSmooth(smPos), t, n);
            setLable(g("#barSpeed_t"), setSpeed(spPos), t, n);
            r.css({width: t,height: n});
            if (s > 0) {
            ...
            if (p.attr("usemap") != undefined) {
                ...
                m.mapAreas.each(function(u) {
                    ...
                    if (m.mouse_drag) {
                        v.bind(m.event_down, {self: m}, m.mouseDown)
                    }
                    if (m.mouse_wheel) {
                        v.bind("mousewheel.sz", {self: m}, m.mouseWheel)
                    }
        ...
        setLocation: function(m) {
            var x = this, n = m, r, t, v, u;
            if (l) {
                n.css(l, "0 0")
            }
            n.css({display: "block","z-index": 2});
            if (x.use3D) {
                n.css({"-webkit-backface-visibility": "hidden","-webkit-perspective": 1000})
            }
            r = n.outerWidth() / 2;
            t = n.outerHeight() / 2;
            ...
            if (n.hasClass("mark")) {
                ...
                g(n.children()[0]).css({position: "absolute",left: (-n.width() / 2),bottom: parseInt(n.css("padding-bottom")) * 2});
                var q = n.find(".text");
                x.locations.push({ob: n,x: parseInt(v[0]),y: parseInt(v[1]),w2: r,h2: t,w2pad: r + (q[0] ? parseInt(q.css("padding-left")) : 0),vis: false,lab: false,lpx: "0",lpy: "0",showAt: isNaN(n.data("show-at-zoom")) ? x.show_at_zoom : parseInt(n.data("show-at-zoom"), 10) / 100,scale: u})
            } else {
                if (n.hasClass("lable")) {
                    var p = n.data("bg-color"), s = n.data("bg-opacity"), y = g(n.eq(0).children()[0]).css({position: "absolute","z-index": 2,left: -r,top: -t});
                    x.locations.push({ob: n,x: parseInt(v[0]),y: parseInt(v[1]),w2: r,h2: t,w2pad: r,vis: false,lab: true,lpx: "0",lpy: "0",showAt: isNaN(n.data("show-at-zoom")) ? x.show_at_zoom : parseInt(n.data("show-at-zoom"), 10) / 100,scale: u});
                    if (p !== "") {
                        if (!p) {
                            p = "#000000";
                            s = 0.7
        ...
        getStyle: function() {
            var m = this.$image;
            return {prop_origin: [l, l !== false && l !== undefined ? m.css(l) : null],prop_transform: [f, f !== false && f !== undefined ? m.css(f) : null],position: ["position", m.css("position")],"z-index": ["z-index", m.css("z-index")],cursor: ["cursor", m.css("cursor")],left: ["left", m.css("left")],top: ["top", m.css("top")],width: ["width", m.css("width")],height: ["height", m.css("height")]}
        },
        ...
        mouseDown: function(n) {
            ...
            if (m.cFlag._nd) {
                ...
                if (n.type == "mousedown") {
                    ...
                    g(k).bind(m.event_move + m.id, {self: m}, m.mouseDrag)
                } else {
        ...
        Animate: function() {
                ...
                if (m.buttons[1].$ob.css("opacity") > 0.5) {
                    if (m.rA >= m.rF && (m.init_zoom == "" || m.rA < m.init_zoom) && (m.zoom_min == "" || m.rA < m.zoom_min)) {
                        ...
                        for (var o = 1; o < (m.pan_limit && !m._moveCursor ? m.buttons_total : 2); o++) {
                            m.buttons[o].$ob.css({opacity: 0.4});
                            m._wheel = false;
            ...
            if (f) {
                ...
                m.$image.css({left: m._x,top: m._y,width: m._w,height: m._h})
            }
            if (m.$loc_cont) {
        ...
        updateLocations: function(v, u, s, t) {
            ...
            for (var n = 0; n < t.length; n++) {
                var o, m, r = (t[n].x * s) + v, q = (t[n].y * s) + u;
                if (s >= t[n].showAt) {
                    if (t[n].scale && f) {
                    ...
                    if (r > -o && r < this.sW + o && ((q > -m && q < this.sH + m && t[n].lab) || (q > 0 && q < this.sH + (m * 2) && !t[n].lab))) {
                        if (!t[n].vis) {
                            t[n].vis = true;
                            if (f) {
                                t[n].ob.stop().css("display", "block").animate({opacity: 1}, 300)
                            } else {
                                t[n].ob.show()
                            }
                        }
                        ...
                        if (t[n].vis) {
                            t[n].vis = false;
                            if (f) {
                                t[n].ob.stop().animate({opacity: 0}, 200, function() {
                                    g(this).hide()
                                })
                            } else {
                                t[n].ob.hide()
        ...
        roundBG: function(n, v, t, q, x, m, s, p, r, o) {
            ...
            g(".bgi" + v).css({position: "absolute",width: x,height: x,"background-image": "url(" + p + ")","background-repeat": "no-repeat","-ms-filter": "progid:DXImageTransform.Microsoft.gradient(startColorstr=#00FFFFFF,endColorstr=#00FFFFFF)",filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#00FFFFFF,endColorstr=#00FFFFFF)",zoom: 1});
            g(".bgh" + v).css({position: "absolute",width: t - x * 2,height: x,"background-color": s,left: x});
            g(".bgc" + v).css({position: "absolute",width: t,height: q - x * 2,"background-color": s,top: x,left: 0})
        },
        ...
        zoomIn: function(m) {
            this.buttons[0].$ob.trigger(this.event_down, {id: 0})
        },
        zoomOut: function(m) {
            this.buttons[1].$ob.trigger(this.event_down, {id: 1})
        },
        moveRight: function(m) {
            this.buttons[2].$ob.trigger(this.event_down, {id: 2})
        },
        moveLeft: function(m) {
            this.buttons[3].$ob.trigger(this.event_down, {id: 3})
        },
        moveUp: function(m) {
            this.buttons[4].$ob.trigger(this.event_down, {id: 4})
        },
        moveDown: function(m) {
            this.buttons[5].$ob.trigger(this.event_down, {id: 5})
        },
        Reset: function(m) {
            this.buttons[6].$ob.trigger(this.event_down, {id: 6})
        },
        getZoomData: function(m) {
            return {normX: (-this._x / this.rA).toFixed(14),normY: (-this._y / this.rA).toFixed(14),normWidth: this.iW,normHeight: this.iH,scaledX: -this._x.toFixed(14),scaledY: -this._y.toFixed(14),scaledWidth: this._w,scaledHeight: this._h,centerX: (-this._x.toFixed(14) + (this.sW / 2)) / this.rA,centerY: (-this._y.toFixed(14) + (this.sH / 2)) / this.rA,ratio: this.rA}
        },
        ...
        resize: function(o) {
            ...
            m.$holder.css({width: m.sW,height: m.sH});
            if (m.bord_size > 0) {
                m.border[0].height(m.sH);
                m.border[1].css({height: m.sH,left: m.sW - m.bord_size});
                m.border[2].width(m.sW - (m.bord_size * 2));
                m.border[3].css({width: m.sW - (m.bord_size * 2),top: m.sH - m.bord_size})
            }
            ...
            m.focusTo({x: m.cX,y: m.cY,zoom: "",speed: 10})
        }
    };
    ...
    var d = function(an, am, al) {
        ...
        function Q(n, m, q) {
            var p = n.charAt(0).toUpperCase() + n.substr(1), o = (n + " " + aa.join(p + " ") + p).split(" ");
            return Y(m, "string") || Y(m, "undefined") ? U(o, m) : (o = (n + " " + Z.join(p + " ") + p).split(" "), S(o, m, q))
        }
        var ak = "2.5.3", aj = {}, ai = am.documentElement, ah = "modernizr", ag = am.createElement(ah), af = ag.style, ae, ad = {}.toString, ac = " -webkit- -moz- -o- -ms- ".split(" "), ab = "Webkit Moz O ms", aa = ab.split(" "), Z = ab.toLowerCase().split(" "), X = {}, V = {}, T = {}, R = [], P = R.slice, O, M = function(w, v, u, t) {
            var s, r, q, p = am.createElement("div"), o = am.body, n = o ? o : am.createElement("body");
            if (parseInt(u, 10)) {
                while (u--) {
        ...
        !Y(K, "undefined") && !Y(K.call, "undefined") ? J = function(n, m) {
            ...
            var o = P.call(arguments, 1), n = function() {
                if (this instanceof n) {
                    var q = function() {
                    };
                    q.prototype = p.prototype;
                    var s = new q, r = p.apply(s, o.concat(P.call(arguments)));
        ...
        var N = function(p, o) {
            var n = p.join(""), m = o.length;
            M(n, function(v, u) {
                var t = am.styleSheets[am.styleSheets.length - 1], s = t ? t.cssRules && t.cssRules[0] ? t.cssRules[0].cssText : t.cssText || "" : "", r = v.childNodes, q = {};
                while (m--) {
                    q[r[m].id] = r[m]
                }
...
(function(a) {
    ...
    a.event.special.mousewheel = {setup: function() {
            ...
            if (this.remove_eventListener)
                for (var a = b.length; a; )
                    this.remove_eventListener(b[--a], d, !1);
            else
...
jQuery(function(c) {
    ...
    var f = c("#settings");
    f.addClass("noSel");
    var a = c("#barSmooth").css({left: smPos + "px"});
    var e = c("#barSmooth_t").css({left: smPos - 3 + "px","-moz-user-select": "none","-khtml-user-select": "none","-webkit-user-select": "none","user-select": "none",cursor: "default"}).addClass("noSel").hide();
    var i = false;
    ...
    var d = c("#barSpeed").css({left: spPos + "px"});
    var b = c("#barSpeed_t").css({left: spPos - 3 + "px","-moz-user-select": "none","-khtml-user-select": "none","-webkit-user-select": "none","user-select": "none",cursor: "default"}).addClass("noSel").hide();
    var g = false;
    ...
    c("#s" + sample).css({"background-position": ((sample - 1) * -111) + "px -44px",cursor: "pointer"});
    c("#s1").bind("mouseover", function(k) {
        if (sample !== 1) {
            c(this).css({"background-position": "0px -22px",cursor: "pointer"})
        }
    }).bind("mouseout", function(k) {
        if (sample !== 1) {
            c(this).css({"background-position": "0px 0px",cursor: "default"})
        }
    ...
    c("#s2").bind("mouseover", function(k) {
        if (sample !== 2) {
            c(this).css({"background-position": "-111px -22px",cursor: "pointer"})
        }
    }).bind("mouseout", function(k) {
        if (sample !== 2) {
            c(this).css({"background-position": "-111px 0px",cursor: "default"})
        }
    }).bind("click", function(k) {
        if (sample !== 2) {
    ...
    c("#s3").bind("mouseover", function(k) {
        if (sample !== 3) {
            c(this).css({"background-position": "-222px -22px",cursor: "pointer"})
        }
    }).bind("mouseout", function(k) {
        if (sample !== 3) {
            c(this).css({"background-position": "-222px 0px",cursor: "default"})
        }
    }).bind("click", function(k) {
        if (sample !== 3) {
    ...
    c("#s4").bind("mouseover", function(k) {
        if (sample !== 4) {
            c(this).css({"background-position": "-333px -22px",cursor: "pointer"})
        }
    }).bind("mouseout", function(k) {
        if (sample !== 4) {
            c(this).css({"background-position": "-333px 0px",cursor: "default"})
        }
    }).bind("click", function(k) {
        if (sample !== 4) {
    ...
    c("#s5").bind("mouseover", function(k) {
        if (sample !== 5) {
            c(this).css({"background-position": "-444px -22px",cursor: "pointer"})
        }
    }).bind("mouseout", function(k) {
        if (sample !== 5) {
            c(this).css({"background-position": "-444px 0px",cursor: "default"})
        }
    }).bind("click", function(k) {
        if (sample !== 5) {
    ...
    c("#s6").bind("mouseover", function(k) {
        if (sample !== 6) {
            c(this).css({"background-position": "-555px -22px",cursor: "pointer"})
        }
    }).bind("mouseout", function(k) {
        if (sample !== 6) {
            c(this).css({"background-position": "-555px 0px",cursor: "default"})
        }
    }).bind("click", function(k) {
        if (sample !== 6) {
    ...
    c("#s7").bind("mouseover", function(k) {
        if (sample !== 7) {
            c(this).css({"background-position": "-666px -22px",cursor: "pointer"})
        }
    }).bind("mouseout", function(k) {
        if (sample !== 7) {
            c(this).css({"background-position": "-666px 0px",cursor: "default"})
        }
    }).bind("click", function(k) {
        if (sample !== 7) {
