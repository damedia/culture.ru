...
namespace Armd\MediaHelperBundle\Gaufrette\Adapter;

use Gaufrette\File;
use Gaufrette\Filesystem;
use Gaufrette\Exception;
use Gaufrette\Adapter\Base;

/**
 * Ftp adapter. This adapter is some kind of patch for native gaufrette ftp adapter.
 *
 * @package ArmdMediaHelperBundle
 * @author  Antoine Hérault <antoine.herault@gmail.com>, shams <info@shams.su>
 */
class Ftp extends Base
{
     ...
     */
    public function __construct($directory, $host, $username = null, $password = null, $port = 21, $passive = false, $create = false, $mode = FTP_BINARY)
    {
