...
class ImportWarGalleryMembersEnCommand extends ContainerAwareCommand
{
    /**
    ...
    {
        $this
            ->setName('armd:museum:import-en-war-gallery-members')
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $finder = new Finder();
        $finder->files()->in($dir .'/txt_en')->name('*.txt')->sortByName();
...
//            \gFuncs::dbgWriteLogVar($file->getRealpath(), false, 'path'); // DBG:
...
//                \gFuncs::dbgWriteLogVar($name, false, 'name'); // DBG:
//                \gFuncs::dbgWriteLogVar($years, false, 'years'); // DBG:
//                \gFuncs::dbgWriteLogVar($ranks, false, 'ranks'); // DBG:
//                continue;
