(function($){
			...
			rlCalendar.prototype.build = function() {
				...
				.bind('click.rlc', function(e) {
					...
					if(_rlc.options.changeMonth)
						_rlc.options.changeMonth(year, month + 1);
			...
			rlCalendar.prototype.selectDays = function(from, to) {
				...
				if(this.options.changeDays)
					this.options.changeDays(from, to);
			};
