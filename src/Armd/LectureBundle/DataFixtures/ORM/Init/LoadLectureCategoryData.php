...
class LoadLectureCategoryData extends AbstractFixture implements OrderedFixtureInterface
{
    /**
    ...
    function load(ObjectManager $manager)
    {
        ...
        $rootCategory->setLectureSuperType($this->getReference('armd_lecture.lecture_super_type.lecture'));
