...
class LoadTvigleData extends AbstractFixture implements OrderedFixtureInterface
{
    private $manager;
    /**
    ...
    function loadReadyTvigles()
    {
        ...
        $this->addReference('armd_lecture.tvigle_video.tvigle_video1', $tvigle);
        ...
        $tvigle->setImage('http://photo.tvigle.ru/res/prt/85deec0537d438363b1c3b54dbe222e8/01/95/000001860195/pub.jpg');
        $this->manager->persist($tvigle);
        $this->addReference('armd_lecture.tvigle_video.tvigle_video2', $tvigle);
        ...
        $tvigle->setImage('http://photo.tvigle.ru/res/prt/85deec0537d438363b1c3b54dbe222e8/01/95/000001860195/pub.jpg');
        $this->manager->persist($tvigle);
        $this->addReference('armd_lecture.tvigle_video.tvigle_video3', $tvigle);
