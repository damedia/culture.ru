...
class Version20120827141743 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("CREATE SEQUENCE content_tvigle_id_seq INCREMENT BY 1 MINVALUE 1 START 1");
        $this->addSql("CREATE SEQUENCE tvigle_task_id_seq INCREMENT BY 1 MINVALUE 1 START 1");
